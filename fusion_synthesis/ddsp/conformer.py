...
class Conformer(nn.Module):
    """The encoder that is used in the Conformer model."""
...
class _EncoderLayer(nn.Module):
    ...
    def __init__(self, parent: Conformer):
...
class FastAttention(nn.Module):
    def __init__(self, dim_heads, nb_features=None, ortho_scaling=0, causal=False, generalized_attention=False,
                 kernel_fn=nn.ReLU(), qr_uniform_q=False, no_projection=False):
        super().__init__()
